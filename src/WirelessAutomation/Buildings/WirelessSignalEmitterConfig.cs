    ...
    public class WirelessSignalEmitterConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            var buildingDef = BuildingTemplates.CreateBuildingDef(
                id: Id, width: 1, height: 1, anim: "wifi_emitter_kanim",
            ...
            buildingDef.LogicInputPorts = new List<LogicPorts.Port>
            {
                LogicPorts.Port.RibbonInputPort(LogicSwitch.PORT_ID, new CellOffset(0, 0),
                    ...
                    STRINGS.BUILDINGS.PREFABS.WIRELESSSIGNALEMITTER.PORT_ACTIVE,
                    STRINGS.BUILDINGS.PREFABS.WIRELESSSIGNALEMITTER.PORT_INACTIVE, true)
            };
